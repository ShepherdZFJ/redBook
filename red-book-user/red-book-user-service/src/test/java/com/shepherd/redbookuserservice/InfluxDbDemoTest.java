...
public class InfluxDbDemoTest{
    ...
    public void testSelect(){
        QueryResult queryOne = influxDBConnection.query("select * from device_value limit 10");
        QueryResult queryOne1 = influxDBConnection.query("show measurements");
        List<QueryResult.Series> series = queryOne.getResults().get(0).getSeries();
        Map<String, String> oneRes = new HashMap<>();
        if (series != null) {
            List<List<Object>> valueList = series.get(0).getValues();
